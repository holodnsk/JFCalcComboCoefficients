...
public class AlbertaCard {
    ...
    */
   public AlbertaCard(int rank, int suit) {
    ...
    */
   public AlbertaCard(char rank, char suit) {
   ...
   public static char getRankChar(int r) {
    ...
    public boolean equals(Object o) {
        ...
        AlbertaCard that = (AlbertaCard) o;
        return gIndex == that.gIndex;
    }
    
    @Override
    public int hashCode() {
        return Objects.hash(gIndex);
    }
}
